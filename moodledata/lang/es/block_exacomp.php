...
/**
 * Strings for component 'block_exacomp', language 'es', branch 'MOODLE_28_STABLE'
 *
...
$string['alltopics'] = 'Todos los temas';
$string['apply_filter'] = 'aplicar filtro';
$string['April'] = 'Abril';
$string['assigndone'] = 'tarea hecha:';
$string['assigned_example'] = 'Ejemplo Asignado';
$string['assignfrom'] = 'de';
$string['assignlearninggroup'] = 'grupo de pares';
$string['assignlearningpartner'] = 'entre pares';
$string['assignmyself'] = 'por mi mismo';
$string['assignteacher'] = 'entrenador';
$string['assignuntil'] = 'hasta';
$string['attachement_example'] = 'Adjunto';
...
$string['column_setting'] = 'mostrar/ocultar columnas';
$string['comp'] = 'Tema';
...
$string['item_file'] = 'Archivo';
$string['item_note'] = 'Nota';
$string['item_title'] = 'Título';
$string['item_type'] = 'Tipo';
$string['item_url'] = 'ULR';
