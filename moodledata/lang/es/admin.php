...
/**
 * Strings for component 'admin', language 'es', branch 'MOODLE_29_STABLE'
 *
 * @package   admin
...
$string['configcronclionly'] = 'Ejecutar cron desde un navegador web puede exponer información privilegiada a usuarios anónimos. Por lo tanto es recomendable sólo ejecutar cron desde una línea de comandos o configurar una contraseña de cron para acceso remoto.';
...
$string['configdbsessions'] = 'Si se habilita esta opción, se utilizará la base de datos para almacenar información acerca de las sesiones actuales. Al cambiar esta configuración se cerrará la sesión de todos los usuarios activos (incluyéndolo a usted). Si está utilizando MySQL asegúrese de que la opción \'max_allowed_packet\' en my.cnf (o my.ini) es de al menos 4MB. Otros controladores de sesión se pueden configurar directamente en el archivo config.php, revise config-dist.php para más información. Esta opción desaparece si se especifica un controlador de sesión en el archivo config.php.';
...
$string['configdocroot'] = 'Define la ruta a Moodle Docs para proveer documentación específica en cada contexto a través de enlaces \'Moodle Docs para esta página\' en el píe de cada página. Si este campo se deja en blanco, los enlaces no se mostrarán.
