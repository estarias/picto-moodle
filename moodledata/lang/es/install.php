...
/**
 * Strings for component 'install', language 'es', branch 'MOODLE_29_STABLE'
 *
 * @package   install
...
$string['dbtype'] = 'Tipo';
$string['directorysettings'] = '<p>Por favor, confirme las ubicaciones de esta instalación de Moodle.</p>

<p><b>Dirección Web:</b>
Especifique la dirección web completa desde donde se accederá a Moodle. Si su sitio web es accesible a través de múltiples URLs, entonces seleccione la más natural que utilizaría uno de sus estudiantes.  No incluya la diagonal invertida final.</p>

<p><b>Directorio de Moodle:</b>
Especifique la ruta completa de esta instalación. Asegúrese de que las mayúsculas/minúsculas sean correctas.

<p><b>Directorio de datos:</b>
Usted necesita un lugar en el que Moodle pueda guardar los archivos subidos. Este directorio debe ser de lectura Y ESCRITURA para el usuario del servidor web (normalmente \'nobody\', \'apache\' o \'www-data\'), pero no debe ser directamente accesible desde la web. El instalador intentará crearlo si no existe.</p>';
