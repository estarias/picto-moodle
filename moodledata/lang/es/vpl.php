...
/**
 * Strings for component 'vpl', language 'es', branch 'MOODLE_29_STABLE'
 *
 * @package   vpl
...
$string['copy'] = 'Copiar';
$string['create_new_file'] = 'Crea un nuevo fichero';
...
$string['downloadallsubmissions'] = 'Descargar las entregas';
...
$string['filenotadded'] = 'El fichero no ha sido añadido';
...
$string['filesChangedNotSaved'] = 'Los archivos han cambiado, pero que no se han guardado';
$string['filesNotChanged'] = 'Los archivos no han cambiado';
$string['filestoscan'] = 'Ficheros a escanear';
...
$string['groupwork'] = 'Trabajo en grupo';
...
$string['othersources'] = 'Otras fuentes para añadir al escaneo';
...
$string['scanoptions'] = 'Opciones de escaneo';
$string['scanother'] = 'Escanear similaridad en otras fuentes';
