...
M.mod_chat_ajax.init = function(Y, cfg) {
    ...
    var gui_ajax = {
        ...
        init : function(cfg) {
			...
			this.pictobutton.on('click', this.send_picto, this, 'feliz');
		...
		send_picto: function(e, picto) {
            if((typeof picto != 'undefined')) {
                this.sendbutton.set('value', M.util.get_string('sending', 'chat'));
                var data = {
                    chat_message : '<p><img border="1" src="https://angelaco.files.wordpress.com/2013/03/feliz.png" alt="feliz" width="100" height="100" /></p><p><audio autoplay controls="true" class="mediaplugin mediaplugin_html5audio" preload="no" title="feliz"><source src="http://arasaac.org/repositorio/locuciones/0/875.mp3" type="audio/mp3"></source><a class="mediafallbacklink" href="http://arasaac.org/repositorio/locuciones/0/875.mp3">feliz</a></audio></p>',
                    chat_sid : this.cfg.sid,
                    theme : this.cfg.theme
                };
                /*if (beep) {
